...
class BiasCalibrationsCadenceForm(BaseCadenceForm):
...
class BiasCalibrationsCadenceStrategy(ResumeCadenceAfterFailureStrategy):
    ...
    def run(self):
        ...
        if last_obs is not None:
            ...
            observation_payload['proposal'] = 'calibrate'  # see lco.py::LCOBaseForm.proposal_choices()
            ...
            facility = get_service_class('Bias Calibrations')()
            form_class = facility.observation_forms['BIAS']
            ...
            form_data = {
                'name': f'Bias for {inst.code}',
                'facility': 'Bias Calibrations',  # TODO: Do something better here
                # This proposal must match a 'current' proposal returned by lco.py::LCOBaseForm.proposal_choices()
                'proposal': self.dynamic_cadence.cadence_parameters.get('proposal', 'calibrate'),  # TODO: Do something better here
        ...
        form = facility.get_form('BIAS')(observation_payload)
